        ...
        if (query) {
            client.fetch(query)
                .then(data => {
                    ...
                    // recommendation for other similar pins
                    if (data[0]) {
                    ...
                    <div className="flex gap-2 items-center">
                        <a 
                            ...
                            download
                                    ...
                                    className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-datk text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                        >
